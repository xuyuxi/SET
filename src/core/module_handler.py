...
# get the menu going
print "\n"
setcore.PrintInfo_spaces("Social-Engineer Toolkit Third Party Modules menu.")
setcore.PrintInfo_spaces("Please read the readme/modules.txt for information on how to create your own modules.\n")
