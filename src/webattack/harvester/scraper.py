...
subprocess.Popen("mv src/program_junk/web_clone/index.html.new src/program_junk/web_clone/%s" % (site), stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True).wait()
